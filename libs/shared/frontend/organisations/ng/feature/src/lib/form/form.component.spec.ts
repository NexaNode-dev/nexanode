...
describe('FormComponent', () => {
  ...
  it('should have a form', () => {
    ...
    const nameInput =
      fixture.elementRef.nativeElement.querySelector('input[id="name"]');
    expect(nameInput).toBeTruthy();
    const typeIdInput =
      fixture.elementRef.nativeElement.querySelector('select[id="type"]');
    expect(typeIdInput).toBeTruthy();
    const descriptionInput = fixture.elementRef.nativeElement.querySelector(
    ...
    const emailInput =
      fixture.elementRef.nativeElement.querySelector('input[id="email"]');
    expect(emailInput).toBeTruthy();
    const phoneInput =
      fixture.elementRef.nativeElement.querySelector('input[id="phone"]');
    expect(phoneInput).toBeTruthy();
    const submitButton = fixture.elementRef.nativeElement.querySelector(
      'button[type="submit"]',
    );
  ...
  it('should validate the form', () => {
    ...
    expect(
      component.name?.touched && component.name?.hasError('required'),
    ).toBeTruthy();
    ...
    expect(
      component.typeId?.touched && component.typeId?.hasError('required'),
    ).toBeTruthy();
    const registrationNumberInput = fixture.debugElement.query(
      By.css('input[id="registrationNumber"]'),
    );
    registrationNumberInput.nativeElement.focus();
    registrationNumberInput.nativeElement.blur();
    expect(
      component.registrationNumber?.touched &&
        component.registrationNumber?.hasError('required'),
    ).toBeTruthy();
    ...
    expect(
      component.email?.touched && component.email?.hasError('required'),
    ).toBeTruthy();
    emailInput.nativeElement.value = 'invalid-email';
    emailInput.nativeElement.dispatchEvent(new Event('input'));
    emailInput.nativeElement.blur();
    expect(
      component.email?.touched && component.email?.hasError('email'),
    ).toBeTruthy();
    ...
    expect(
      component.phone?.touched && component.phone?.hasError('required'),
    ).toBeTruthy();
  });
});
